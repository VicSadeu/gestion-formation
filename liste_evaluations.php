...
$sql = "SELECT * FROM evaluer,formation,participant WHERE evaluer.id_for=formation.id_for AND evaluer.id_part=participant.id_part";
...
header('losation:liste_evaluation.php');
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-danger btn-xs" onclick="return confirm('vous voulez sure de vouloir supprimer ?')" href='supprimer_eval.php?id_for=<?php echo $produit['id_for'] ?>&id_part=<?php echo $produit['id_part'] ?>'><i class="fa fa-trash-o "> Supprimer</i></a>
                    </td>
                  </tr>
                  <?php endforeach;?>
