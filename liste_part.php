          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> liste de tout les participants</h4>
                <hr>
                <thead>
                  <tr>
                  <th><i class="fa fa-question-circle"></i> identifiant</th>
                ...
                <?php
                  ...
                  <td>
                    ...
                    <td>
                      <b><?=$produit['nom_part'] ?></b>
                    </td>
                    <td class="hidden-phone"><?=$produit['prenom_part'] ?></td>
                    <td><?=$produit['pseudo_part'] ?> </td>
                    <td><?=$produit['email_part'] ?></td>
                    <td><?=$produit['tel_part'] ?></td>
                    <td>
                    <a class="btn btn-success btn-xs" data-toggle="modal" href="login.html#myModal"><i class="fa fa-check"></i></a>
                     
                      <a class="btn btn-danger btn-xs" onclick="return confirm('vous voulez sure de vouloir supprimer ?')" href='supprimer_part.php?id_part=<?php echo $produit['id_part'] ?>'><i class="fa fa-trash-o "></i></a>
                    </td>
                  </tr>
                  <?php endforeach;?>
