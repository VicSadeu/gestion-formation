...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="connect-part.php" method="POST">
        ...
        <div class="login-wrap">
          ...
          <br>
          <input type="password" class="form-control" autocomplete="off" placeholder="Mot de passe" name="password_part"><br>
          ...
          if(isset($_GET['erreur'])){
            ...
            if($err==1){
              ...
              echo"<p style='color:red'>Veuillez entrer tous les champs svp !!!</p>";
            }
          }
          ?>
          <hr>
